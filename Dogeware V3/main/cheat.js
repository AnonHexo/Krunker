    ...
    let initGUI
    {
        function getGuiHtml() {
            ...
            let built = `<div id="settHolder">
                ...
                <h5 style="margin: 15px 0">Developed by <a href="https:/gg.cheems.art/">chonker1337</a>, Join <a href="https:/dogeware.cheems.art/gg">Gaming Gurus</a> fro more hacks.<br></h5>`
            ...
            tab(3, () => {
                ...
                builder.checkbox("Aim when target visible", "awtv", "Aim when target visible")
                builder.checkbox("Unaim when no target visible", "uwtv", "Unaim when no target visible")
                builder.checkbox("Force unsilent", "forceUnsilent", "Force ")
            })
